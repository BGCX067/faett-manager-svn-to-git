 ...
 */
class Faett_Manager_Model_Session extends Mage_Adminhtml_Model_Session
{

    /**
     * Adding a new console message to the session.
     *
     * @param string $message The message to add
     * @return Faett_Manager_Model_Session The session
     */
    public function addConsole($message)
    {
        $this->addMessage(Mage::getSingleton('manager/message')->console($message));
        return $this;
    }
}
