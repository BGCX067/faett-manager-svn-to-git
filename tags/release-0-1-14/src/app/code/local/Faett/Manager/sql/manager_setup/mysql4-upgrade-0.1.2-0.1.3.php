...
$installer->run("
ALTER TABLE `faett_channel` ADD `username` varchar(255) NOT NULL default '' AFTER alias;
ALTER TABLE `faett_channel` ADD `password` varchar(255) NOT NULL default '' AFTER username;
");
