...
/**
 * Faett_Manager_Exceptions_InvalidLicenceException
 *
 * NOTICE OF LICENSE
 * 
 ...
 */
class Faett_Manager_Exceptions_InvalidLicenceException
     ...
     * @return Faett_Manager_Exceptions_InvalidLicenceException
     */
    public static function create($message, $key = '') {
        // create a new message
        $e = new Faett_Manager_Exceptions_InvalidLicenceException($message);
        // set the message key
        $e->_setKey($key);
        // return the message
        return $e;
