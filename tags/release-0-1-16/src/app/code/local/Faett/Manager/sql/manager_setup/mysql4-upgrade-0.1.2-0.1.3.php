...
$installer->run("
ALTER TABLE `{$installer->getTable('manager/channel')}` ADD `username` varchar(255) NOT NULL default '' AFTER alias;
ALTER TABLE `{$installer->getTable('manager/channel')}` ADD `password` varchar(255) NOT NULL default '' AFTER username;
");
