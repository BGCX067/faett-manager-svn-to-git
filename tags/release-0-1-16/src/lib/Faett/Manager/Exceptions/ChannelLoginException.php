...
/**
 * Faett_Manager_Exceptions_ChannelLoginException
 *
 * NOTICE OF LICENSE
 * 
 ...
 */
class Faett_Manager_Exceptions_ChannelLoginException
     ...
     * @return Faett_Manager_Exceptions_ChannelLoginException
     */
    public static function create($message, $key = '') {
        // create a new message
        $e = new Faett_Manager_Exceptions_ChannelLoginException($message);
        // set the message key
        $e->_setKey($key);
        // return the message
        return $e;
