...
/**
 * Faett_Manager_Exceptions_InvalidCommandException
 *
 * NOTICE OF LICENSE
 * 
 ...
 */
class Faett_Manager_Exceptions_InvalidCommandException
     ...
     * @return Faett_Manager_Exceptions_InvalidCommandException
     */
    public static function create($message, $key = '') {
        // create a new message
        $e = new Faett_Manager_Exceptions_InvalidCommandException($message);
        // set the message key
        $e->_setKey($key);
        // return the message
        return $e;
